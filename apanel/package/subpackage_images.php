...
if (isset($_GET['page']) && $_GET['page'] == "package" && isset($_GET['mode']) && $_GET['mode'] == "subpackageImageList"):
    ...
    if (!$glRec) {
        echo "<div class='alert alert-danger'>Subpackage not found!</div>";
        exit;
    }
...
?>
    <h3>
        <?php echo (isset($_GET['id'])) ? 'IMAGE' : 'Add Package'; ?>
        ...
        $(document).ready(function() {
            $('#users_upload').uploadify({
                ...
                'onUploadSuccess': function(file, data, response) {
                    ...
                    var filename = data;
                    $.post('<?php echo BASE_URL; ?>apanel/package/uploaded_gallery_image1.php', {
                        imagefile: filename
                    }, function(msg) {
