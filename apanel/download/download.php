...
<script type="text/javascript">
 ...
 $(document).ready(function() {
    ...
    $('#background_upload').uploadify({
        ...
        'formData'   : {PROJECT : '<?php echo SITE_FOLDER;?>',targetFolder:'images/download/',thumb_width:200,thumb_height:200},
        'method'     : 'post',
       ...
       /* 'checkExisting' : '/uploadify/check-exists.php',*/
         'onUploadSuccess' : function(file, data, response) {
            ...
            var filename =  data;
            $.post('<?php echo BASE_URL;?>apanel/download/uploaded_logo.php',{imagefile:filename},function(msg){          
        ...
        'formData'   : {PROJECT : '<?php echo SITE_FOLDER;?>',targetFolder:'images/download/docs/',thumb_width:200,thumb_height:200},
        'method'     : 'post',
        'cancelImg'  : '<?php echo BASE_URL;?>uploadify/cancel.png',
        'auto'       : true,
        'multi'      : false,   
       ...
       /* 'checkExisting' : '/uploadify/check-exists.php',*/
        'onUploadSuccess' : function(file, data, response) {
            $('#uploadedImageName').val('1');
            var filename =  data;
            $.post('<?php echo BASE_URL;?>apanel/download/uploaded_image.php',{imagefile:filename},function(msg){           
